...
\restrict KO5fqIejnvjP1OrBjFFaF55QF4qTvxNhwvwa3JchPbUX1sUPggDP4o3gzmwyEp3
...
--
-- Name: enum_blog_posts_media_type; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public.enum_blog_posts_media_type AS ENUM (
    'none',
    'instagram',
    'youtube'
);
...
--
-- Name: enum_partners_status; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: enum_quote_requests_interested_in; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public.enum_quote_requests_interested_in AS ENUM (
    'newConstruction',
    'renovation'
);
...
--
-- Name: enum_quote_requests_renovation_object; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public.enum_quote_requests_renovation_object AS ENUM (
    'house',
    'apartment',
    'serviceSpace',
    'office',
...
--
-- Name: enum_quote_requests_renovation_type; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public.enum_quote_requests_renovation_type AS ENUM (
    'turnkeyNoProject',
    'turnkeyWithProject',
    'refresh',
    'repairs'
...
--
-- Name: enum_quote_requests_status; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: enum_reviews_original_language; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public.enum_reviews_original_language AS ENUM (
    'en',
    'pl',
    'uk',
    'ru'
...
--
-- Name: enum_reviews_video_source; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public.enum_reviews_video_source AS ENUM (
    'none',
    'upload',
    'instagram'
);
...
--
-- Name: enum_trusted_brands_status; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public.enum_trusted_brands_status AS ENUM (
    'draft',
    'published'
);
...
CREATE TABLE public.blog_posts (
    ...
    media_type public.enum_blog_posts_media_type DEFAULT 'none'::public.enum_blog_posts_media_type NOT NULL,
...
CREATE TABLE public.partners (
    ...
    status public.enum_partners_status DEFAULT 'active'::public.enum_partners_status NOT NULL,
    "order" numeric DEFAULT 0,
    updated_at timestamp(3) with time zone DEFAULT now() NOT NULL,
    created_at timestamp(3) with time zone DEFAULT now() NOT NULL,
    description_pl character varying,
...
CREATE TABLE public.projects (
    ...
    title character varying NOT NULL,
    slug character varying NOT NULL,
    category public.enum_projects_category NOT NULL,
...
--
-- Name: projects_rels; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: projects_rels_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: projects_rels_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
CREATE TABLE public.quote_requests (
    ...
    renovation_type public.enum_quote_requests_renovation_type NOT NULL,
    work_description character varying,
    status public.enum_quote_requests_status DEFAULT 'new'::public.enum_quote_requests_status NOT NULL,
    owner_reminder_date timestamp(3) with time zone,
    internal_notes character varying,
    updated_at timestamp(3) with time zone DEFAULT now() NOT NULL,
    created_at timestamp(3) with time zone DEFAULT now() NOT NULL,
    interested_in public.enum_quote_requests_interested_in NOT NULL,
    renovation_object public.enum_quote_requests_renovation_object NOT NULL,
...
--
-- Name: quote_requests_rels; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.quote_requests_rels (
    id integer NOT NULL,
    "order" integer,
    parent_id integer NOT NULL,
    path character varying NOT NULL,
...
--
-- Name: quote_requests_rels_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.quote_requests_rels_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: quote_requests_rels_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.quote_requests_rels_id_seq OWNED BY public.quote_requests_rels.id;
...
CREATE TABLE public.reviews (
    ...
    original_language public.enum_reviews_original_language DEFAULT 'en'::public.enum_reviews_original_language NOT NULL,
    photo_id integer,
    status public.enum_reviews_status DEFAULT 'pending'::public.enum_reviews_status NOT NULL,
    featured boolean DEFAULT false,
    internal_notes character varying,
    updated_at timestamp(3) with time zone DEFAULT now() NOT NULL,
    created_at timestamp(3) with time zone DEFAULT now() NOT NULL,
    translations_en character varying,
    translations_pl character varying,
    translations_uk character varying,
    translations_ru character varying,
    video_id integer,
    google_review_url character varying,
    video_source public.enum_reviews_video_source DEFAULT 'none'::public.enum_reviews_video_source NOT NULL,
    instagram_url character varying,
    instagram_poster_id integer
);
...
CREATE TABLE public.services (
    ...
    slug character varying NOT NULL,
    featured boolean DEFAULT false,
    status public.enum_services_status DEFAULT 'draft'::public.enum_services_status,
    "order" numeric DEFAULT 0,
    updated_at timestamp(3) with time zone DEFAULT now() NOT NULL,
    created_at timestamp(3) with time zone DEFAULT now() NOT NULL
);
...
--
-- Name: services_items; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: trusted_brands; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.trusted_brands (
    ...
    status public.enum_trusted_brands_status DEFAULT 'published'::public.enum_trusted_brands_status,
    "order" numeric DEFAULT 0,
    updated_at timestamp(3) with time zone DEFAULT now() NOT NULL,
    created_at timestamp(3) with time zone DEFAULT now() NOT NULL,
    description_pl character varying,
    ...
    project_preview_image_id integer
);


--
-- Name: trusted_brands_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: trusted_brands_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: projects_rels id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: quote_requests_rels id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.quote_requests_rels ALTER COLUMN id SET DEFAULT nextval('public.quote_requests_rels_id_seq'::regclass);
...
--
-- Name: trusted_brands id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: projects_rels projects_rels_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: quote_requests_rels quote_requests_rels_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.quote_requests_rels
    ADD CONSTRAINT quote_requests_rels_pkey PRIMARY KEY (id);
...
--
-- Name: services_items services_items_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: trusted_brands trusted_brands_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: blog_posts_published_at_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: payload_locked_documents_rels_quote_requests_id_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX payload_locked_documents_rels_quote_requests_id_idx ON public.payload_locked_documents_rels USING btree (quote_requests_id);
...
--
-- Name: payload_locked_documents_rels_trusted_brands_id_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX payload_locked_documents_rels_trusted_brands_id_idx ON public.payload_locked_documents_rels USING btree (trusted_brands_id);
...
--
-- Name: projects_rels_media_id_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: projects_rels_order_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: projects_rels_parent_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: projects_rels_path_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: quote_requests_created_at_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX quote_requests_created_at_idx ON public.quote_requests USING btree (created_at);


--
-- Name: quote_requests_rels_media_id_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX quote_requests_rels_media_id_idx ON public.quote_requests_rels USING btree (media_id);


--
-- Name: quote_requests_rels_order_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX quote_requests_rels_order_idx ON public.quote_requests_rels USING btree ("order");


--
-- Name: quote_requests_rels_parent_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX quote_requests_rels_parent_idx ON public.quote_requests_rels USING btree (parent_id);


--
-- Name: quote_requests_rels_path_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX quote_requests_rels_path_idx ON public.quote_requests_rels USING btree (path);


--
-- Name: quote_requests_updated_at_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX quote_requests_updated_at_idx ON public.quote_requests USING btree (updated_at);
...
--
-- Name: reviews_instagram_poster_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX reviews_instagram_poster_idx ON public.reviews USING btree (instagram_poster_id);


--
-- Name: reviews_photo_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX reviews_photo_idx ON public.reviews USING btree (photo_id);
...
--
-- Name: reviews_video_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX reviews_video_idx ON public.reviews USING btree (video_id);
...
--
-- Name: services_items_order_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX services_items_order_idx ON public.services_items USING btree (_order);


--
-- Name: services_items_parent_id_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX services_items_parent_id_idx ON public.services_items USING btree (_parent_id);
...
--
-- Name: trusted_brands_created_at_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX trusted_brands_created_at_idx ON public.trusted_brands USING btree (created_at);


--
-- Name: trusted_brands_featured_project_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX trusted_brands_featured_project_idx ON public.trusted_brands USING btree (featured_project_id);


--
-- Name: trusted_brands_logo_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX trusted_brands_logo_idx ON public.trusted_brands USING btree (logo_id);


--
-- Name: trusted_brands_project_preview_image_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX trusted_brands_project_preview_image_idx ON public.trusted_brands USING btree (project_preview_image_id);


--
-- Name: trusted_brands_updated_at_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX trusted_brands_updated_at_idx ON public.trusted_brands USING btree (updated_at);
...
--
-- Name: payload_locked_documents_rels payload_locked_documents_rels_quote_requests_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.payload_locked_documents_rels
    ADD CONSTRAINT payload_locked_documents_rels_quote_requests_fk FOREIGN KEY (quote_requests_id) REFERENCES public.quote_requests(id) ON DELETE CASCADE;
...
--
-- Name: payload_locked_documents_rels payload_locked_documents_rels_trusted_brands_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.payload_locked_documents_rels
    ADD CONSTRAINT payload_locked_documents_rels_trusted_brands_fk FOREIGN KEY (trusted_brands_id) REFERENCES public.trusted_brands(id) ON DELETE CASCADE;
...
--
-- Name: projects_rels projects_rels_media_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: projects_rels projects_rels_parent_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: quote_requests_rels quote_requests_rels_media_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.quote_requests_rels
    ADD CONSTRAINT quote_requests_rels_media_fk FOREIGN KEY (media_id) REFERENCES public.media(id) ON DELETE CASCADE;


--
-- Name: quote_requests_rels quote_requests_rels_parent_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.quote_requests_rels
    ADD CONSTRAINT quote_requests_rels_parent_fk FOREIGN KEY (parent_id) REFERENCES public.quote_requests(id) ON DELETE CASCADE;


--
-- Name: reviews reviews_instagram_poster_id_media_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.reviews
    ADD CONSTRAINT reviews_instagram_poster_id_media_id_fk FOREIGN KEY (instagram_poster_id) REFERENCES public.media(id) ON DELETE SET NULL;


--
-- Name: reviews reviews_photo_id_media_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.reviews
    ADD CONSTRAINT reviews_photo_id_media_id_fk FOREIGN KEY (photo_id) REFERENCES public.media(id) ON DELETE SET NULL;


--
-- Name: reviews reviews_video_id_media_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.reviews
    ADD CONSTRAINT reviews_video_id_media_id_fk FOREIGN KEY (video_id) REFERENCES public.media(id) ON DELETE SET NULL;


--
-- Name: services_items services_items_parent_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.services_items
    ADD CONSTRAINT services_items_parent_id_fk FOREIGN KEY (_parent_id) REFERENCES public.services(id) ON DELETE CASCADE;


--
-- Name: trusted_brands trusted_brands_featured_project_id_projects_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.trusted_brands
    ADD CONSTRAINT trusted_brands_featured_project_id_projects_id_fk FOREIGN KEY (featured_project_id) REFERENCES public.projects(id) ON DELETE SET NULL;


--
-- Name: trusted_brands trusted_brands_logo_id_media_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.trusted_brands
    ADD CONSTRAINT trusted_brands_logo_id_media_id_fk FOREIGN KEY (logo_id) REFERENCES public.media(id) ON DELETE SET NULL;


--
-- Name: trusted_brands trusted_brands_project_preview_image_id_media_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.trusted_brands
    ADD CONSTRAINT trusted_brands_project_preview_image_id_media_id_fk FOREIGN KEY (project_preview_image_id) REFERENCES public.media(id) ON DELETE SET NULL;
...
\unrestrict KO5fqIejnvjP1OrBjFFaF55QF4qTvxNhwvwa3JchPbUX1sUPggDP4o3gzmwyEp3
