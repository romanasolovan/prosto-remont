...
const ContactIcons = {
  ...
  phone: (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M31 33c-9 0-16-7-16-16 0-2 3-4 4-4l3 6-2 2c1 3 3 5 6 6l2-2 6 3c0 1-2 5-3 5z" />
    </svg>
  ),
  hours: (
    <svg
          ...
          <section className={styles.contactRow}>
            <div className={styles.detailsColumn}>
              ...
              <div className={styles.socialInline}>
                <span className={styles.socialLabel}>{t("social.title")}</span>
            ...
            <div className={styles.mapColumn}>
              <div className={styles.mapFrame} aria-label={t("map.ariaLabel")}>
                <div className={styles.mapTag}>
                  <span className={styles.mapTagLabel}>{t("map.title")}</span>
                  <span className={styles.mapTagTitle}>Warsaw, PL</span>
                </div>
