...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_quote_requests_interested_in" AS ENUM('newConstruction', 'renovation');
  CREATE TYPE "public"."enum_quote_requests_renovation_type" AS ENUM('turnkeyNoProject', 'turnkeyWithProject', 'refresh', 'repairs');
  CREATE TYPE "public"."enum_quote_requests_renovation_object" AS ENUM('house', 'apartment', 'serviceSpace', 'office', 'bathroom', 'room');
  CREATE TYPE "public"."enum_quote_requests_status" AS ENUM('new', 'contacted', 'estimate-sent', 'accepted', 'rejected', 'completed');
  ...
  CREATE TABLE "quote_requests" (
  	...
  	"email" varchar NOT NULL,
  	"interested_in" "enum_quote_requests_interested_in" NOT NULL,
  	"renovation_type" "enum_quote_requests_renovation_type" NOT NULL,
  	"renovation_object" "enum_quote_requests_renovation_object" NOT NULL,
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_quote_requests_interested_in";
  DROP TYPE "public"."enum_quote_requests_renovation_type";
  DROP TYPE "public"."enum_quote_requests_renovation_object";
